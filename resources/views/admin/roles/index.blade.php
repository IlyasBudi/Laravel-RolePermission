...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Create and manage user roles</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
        ...
        @else
            <div class="px-6 py-12 text-center">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating your first role.</p>
                <div class="mt-6">
                    <a href="{{ route('admin.roles.create') }}" 
